    ...
    >
      <div className="w-full">
        ...
        <Link
          ...
          gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r 
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-centre 
      justify-between'>
        <div className='flex gap-2 items-centre cursor-pointer'>
          <UserButton/>
          <div>
